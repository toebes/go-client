...
// GBTToleranceType the model 'GBTToleranceType'
type GBTToleranceType string
...
var AllowedGBTToleranceTypeEnumValues = []GBTToleranceType{
	"NONE",
	"SYMMETRICAL",
	"DEVIATION",
	"LIMITS",
...
func (v *GBTToleranceType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := GBTToleranceType(value)
	for _, existing := range AllowedGBTToleranceTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid GBTToleranceType", value)
}

// NewGBTToleranceTypeFromValue returns a pointer to a valid GBTToleranceType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewGBTToleranceTypeFromValue(v string) (*GBTToleranceType, error) {
	ev := GBTToleranceType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for GBTToleranceType: valid values are %v", v, AllowedGBTToleranceTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v GBTToleranceType) IsValid() bool {
	for _, existing := range AllowedGBTToleranceTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to GBTToleranceType value
func (v GBTToleranceType) Ptr() *GBTToleranceType {
	return &v
}

type NullableGBTToleranceType struct {
	value *GBTToleranceType
	isSet bool
}

func (v NullableGBTToleranceType) Get() *GBTToleranceType {
	return v.value
}

func (v *NullableGBTToleranceType) Set(val *GBTToleranceType) {
	v.value = val
	v.isSet = true
}

func (v NullableGBTToleranceType) IsSet() bool {
	return v.isSet
}

func (v *NullableGBTToleranceType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGBTToleranceType(val *GBTToleranceType) *NullableGBTToleranceType {
	return &NullableGBTToleranceType{value: val, isSet: true}
}

func (v NullableGBTToleranceType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGBTToleranceType) UnmarshalJSON(src []byte) error {
	v.isSet = true
