...
**CloudStorageAccountId** | Pointer to **string** | Account id to access the cloud storage. | [optional] 
...
**EmailSubject** | Pointer to **string** | Subject to send the email with. | [optional] 
**EmailTo** | Pointer to **[]string** | List of email addresses to send the email to. | [optional] 
...
**FromUserId** | Pointer to **string** | Id of the user who does the export. | [optional] 
**GetyAxisIsUp** | Pointer to **bool** |  | [optional] 
**Grouping** | Pointer to **bool** | Whether parts should be exported as a group or individually in a .zip file. | [optional] 
**HideInspectionItems** | Pointer to **bool** |  | [optional] 
**IgnoreExportRulesForContents** | Pointer to **bool** | For multiple elements export, use &#x60;true&#x60; if export rule shouldn&#39;t be applied for all elements. | [optional] 
...
**ParasolidMode** | Pointer to [**GBTParasolidEncodingType**](GBTParasolidEncodingType.md) |  | [optional] [default to TEXT]
