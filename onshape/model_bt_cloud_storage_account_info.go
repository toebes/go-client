...
func (o *BTCloudStorageAccountInfo) GetParentId() string {
...
// and a boolean to check if the value has been set.
func (o *BTCloudStorageAccountInfo) GetParentIdOk() (*string, bool) {
	if o == nil || o.ParentId == nil {
		return nil, false
	}
...
func (o *BTCloudStorageAccountInfo) HasParentId() bool {
	if o != nil && o.ParentId != nil {
		return true
	}
...
func (o *BTCloudStorageAccountInfo) SetParentId(v string) {
	o.ParentId = &v
}
