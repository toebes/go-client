...
func (o *BTCompanyUserSummaryInfo) GetIsExternal() bool {
...
// and a boolean to check if the value has been set.
func (o *BTCompanyUserSummaryInfo) GetIsExternalOk() (*bool, bool) {
	if o == nil || o.IsExternal == nil {
		return nil, false
	}
...
func (o *BTCompanyUserSummaryInfo) HasIsExternal() bool {
	if o != nil && o.IsExternal != nil {
		return true
	}
...
func (o *BTCompanyUserSummaryInfo) SetIsExternal(v bool) {
	o.IsExternal = &v
}
